...
```{r}
chat_g$chat(paste("Examine these logs and rank common issues described in the narrative. Minimize specificity and give broader categories that can neatly group each incident type. Also provide a count for each with the ranking.",data$narrative_121))
```
